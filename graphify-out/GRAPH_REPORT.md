...
## Corpus Check
- 107 files · ~656,677 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 963 nodes · 1625 edges · 65 communities (60 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf75678b`
...
Cohesion: 0.08
Nodes (40): checkPointInGeoJSON(), CustomerDetailView(), CustomerManagement(), isPointInPolygon(), L, store(), getCustomerAccessLevel(), AGENT_COLORS (+32 more)
...
Cohesion: 0.08
Nodes (61): AgentInventoryView(), getCurrentDate(), KPMInventoryApp(), AuditVaultView(), BranchWarehouseManager(), confirmAction(), promptAction(), DashboardBenchmarks() (+53 more)
...
Cohesion: 0.15
Nodes (13): 🟠 2026-08-18 17:06 — five stock bugs of ONE shape, all shipped, 🟠 2026-08-18 17:17 — one debt number, and 23 silent failures given a voice, 🟠 2026-08-18 17:38 — EOD: the count finally decides the report. `d859d41`, 🟠 2026-08-18 18:56 — EOD shortfall → bounty. ANSWERED AND SHIPPED. `7f96d19`, 🟠 2026-08-18 19:44 — The admin can now SEE the gap. `ce70287`, 🟠 2026-08-18 19:54 — two off his OWN to-do list, both found while shipping the card, 🟠 2026-08-18 19:57 — notes trimmed, not the work, 🟠 2026-08-18 20:14 — a missing pack is bought back at retail. ANSWERED AND SHIPPED. `43f8059` (+5 more)
...
Cohesion: 0.42
Nodes (8): hasClearance(), MerchantSalesView(), reorderFromLast(), agoLabel(), paymentLabel(), splitToUnits(), directionsUrl(), metresLabel()
