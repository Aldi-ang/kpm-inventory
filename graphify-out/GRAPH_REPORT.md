...
## Corpus Check
- 107 files · ~646,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 947 nodes · 1591 edges · 62 communities (57 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `883a62e1`
...
Cohesion: 0.16
Nodes (9): BULAN, REEL, NotificationBell(), app, auth, db, firebaseConfig, googleProvider (+1 more)

### Community 31 - "txSize.selfcheck.mjs"
Cohesion: 0.07
Nodes (63): AgentInventoryView(), getCurrentDate(), KPMInventoryApp(), AuditVaultView(), BranchWarehouseManager(), confirmAction(), promptAction(), CrownTransferProtocol() (+55 more)
...
Cohesion: 0.25
Nodes (8): 🟠 2026-08-18 13:2x WIB — KPM app track — SALE-ENGINE NAME BUGS: SHIPPED `264c138`, 🟠 2026-08-18 13:3x WIB — KPM app track — PAUSED ON QUOTA, NOTHING HALF-DONE, 🟠 2026-08-18 14:4x WIB — KPM app track — STORE-DEBT TALLY: SHIPPED `4b63118`, 🟠 2026-08-18 15:5x WIB — KPM app track — MAP NAME MATCHING: SHIPPED `a3a9cf6`, 🟠 2026-08-18 15:5x WIB — KPM app track — NAME SWEEP: SHIPPED `f1e3b28`, 🟠 2026-08-18 16:29 WIB — KPM app track — THE GUARD, AND THE 8 IT FOUND: SHIPPED `ef437b1`, ▶ NOW, PROGRESS — read this, search for nothing
...
Cohesion: 0.50
Nodes (3): DETECTED_TRACKS, musicModules, MusicPlayer()
...
## Knowledge Gaps
- **494 isolated node(s):** `root`, `note`, `hook`, `now`, `hook` (+489 more)
...
- **Why does `formatRupiah()` connect `txSize.selfcheck.mjs` to `App.jsx`, `dayStats.selfcheck.mjs`, `context-watch.mjs`, `JourneyView.jsx`?**
