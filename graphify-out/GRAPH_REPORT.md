...
## Corpus Check
- 107 files · ~652,738 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 958 nodes · 1604 edges · 61 communities (56 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d859d413`
...
Cohesion: 0.05
Nodes (55): AgentInventoryView(), getCurrentDate(), DashboardBenchmarks(), CustomTooltip(), DashboardView(), formatAdvancedStock(), ItemInspector(), ResidentEvilInventory() (+47 more)

### Community 23 - "JourneyView.jsx"
Cohesion: 0.06
Nodes (45): L, blank, done, eightDaysAgo, far, free, HERE, minefar (+37 more)
...
Cohesion: 0.08
Nodes (57): AuditVaultView(), BranchWarehouseManager(), CareerDevTools(), confirmAction(), promptAction(), CrownTransferProtocol(), checkPointInGeoJSON(), CustomerDetailView() (+49 more)
...
Cohesion: 0.52
Nodes (5): canReachInternet(), useOfflineEngine(), applySaleToCanvas(), useTransactionEngine(), stripCartItemForStorage()

### Community 36 - "KPMInventoryApp"
Cohesion: 0.33
Nodes (8): getDocOfflineSafe(), KPMInventoryApp(), gateHoldMs(), gateIsRich(), clearGrace(), graceIsValid(), readGrace(), touchGrace()
...
Cohesion: 0.14
Nodes (14): 🟠 2026-08-18 13:2x WIB — KPM app track — SALE-ENGINE NAME BUGS: SHIPPED `264c138`, 🟠 2026-08-18 13:3x WIB — KPM app track — PAUSED ON QUOTA, NOTHING HALF-DONE, 🟠 2026-08-18 14:4x WIB — KPM app track — STORE-DEBT TALLY: SHIPPED `4b63118`, 🟠 2026-08-18 15:5x WIB — KPM app track — MAP NAME MATCHING: SHIPPED `a3a9cf6`, 🟠 2026-08-18 15:5x WIB — KPM app track — NAME SWEEP: SHIPPED `f1e3b28`, 🟠 2026-08-18 16:29 WIB — KPM app track — THE GUARD, AND THE 8 IT FOUND: SHIPPED `ef437b1`, 🟠 2026-08-18 16:38 WIB — KPM app track — OLD NAMES CLEANED ON SCREEN: SHIPPED `883a62e`, 🟠 2026-08-18 16:47 — pack-size maths: 4 broken conversions → `convertToBks`. `f51a3a9` (+6 more)
...
### Community 61 - "toastSeverity.selfcheck.mjs"
Cohesion: 0.28
Nodes (7): FADE, MASCOT_CHATTER, MASCOT_FAILURES, report(), STICKY, isFailure(), isSticky()

## Knowledge Gaps
- **504 isolated node(s):** `root`, `note`, `hook`, `now`, `hook` (+499 more)
...
- **Why does `formatRupiah()` connect `dayStats.selfcheck.mjs` to `App.jsx`, `dayStats.selfcheck.mjs`, `JourneyView.jsx`, `txSize.selfcheck.mjs`?**
