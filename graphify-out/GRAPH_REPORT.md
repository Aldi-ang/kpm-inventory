...
## Corpus Check
- 108 files · ~680,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1007 nodes · 1677 edges · 69 communities (63 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a372433c`
...
Cohesion: 0.08
Nodes (32): hook, k(), left, lines, pct, react, react, AuthoritySelect() (+24 more)
...
Cohesion: 0.21
Nodes (14): AgentInventoryView(), getCurrentDate(), Money(), DashboardBenchmarks(), CustomTooltip(), DashboardView(), SafetyStatus(), EODReconciliationView() (+6 more)
...
### Community 63 - "notify"
Cohesion: 0.23
Nodes (17): AuditVaultView(), confirmAction(), CrownTransferProtocol(), CustomerDetailView(), HistoryReportView(), LandlordDashboard(), notify(), ToastHost() (+9 more)
...
### Community 66 - "StockOpnameView.jsx"
Cohesion: 0.42
Nodes (8): BranchWarehouseManager(), promptAction(), RestockVaultView(), StockOpnameView(), compressImageToBase64(), deletePhotoFromStorage(), savePhotoAndGetReference(), tierPrice()

### Community 67 - "nextStop.js"
Cohesion: 0.70
Nodes (4): km(), mine(), nextStop(), visitedWithinCycle()

### Community 68 - "ResidentEvilInventory.jsx"
Cohesion: 0.60
...
- **Why does `formatRupiah()` connect `txSize.selfcheck.mjs` to `App.jsx`, `dayStats.selfcheck.mjs`, `MapMissionControl.jsx`, `StockOpnameView.jsx`, `ResidentEvilInventory.jsx`, `notify`?**
